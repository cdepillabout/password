...
Generally, the most "secure" algorithm is believed to be @"Data.Password.Argon2"@,
then @"Data.Password.Scrypt"@, then @"Data.Password.Bcrypt"@, and lastly
@"Data.Password.PBKDF2"@. @"Data.Password.Bcrypt"@ and @"Data.Password.PBKDF2"@
...
@"Data.Password.Bcrypt"@ if your password does not need the highest security possible.
